...
@Component
public class AppInfoLogDaoImpl implements AppInfoLogDao, BaseDaoInterface<AppInfoLog> {
    @Autowired
    ...
    public List<Map<String, Object>> getApiList(AppInfoLog appInfoLog) throws NoSuchMethodException, AnnotationException, IllegalAccessException, NoSuchFieldException {
        return baseDao.handleSearch(this,"getApiList",AppInfoLog.class,appInfoLog);
    }
}
